...
class _Api {
  ...
  void throwExceptionIfKeyExists({required String key, required Map data}) {
    ...
    try {
      ...
      final res = await method
          ...
          .when(
            ...
            others: (fn) async =>
                await fn.call(uri, body: body, headers: headers),
          );
  ...
  Future<model.Result<model.NcProjectList>> baseList(
    ...
    method: HttpMethod.get,
    pathSegments: ['/api/v1/workspaces', workspaceId, 'bases'],
    serializer: (_, data) =>
        model.NcProjectList.fromJson(data, model.fromJsonT<model.NcProject>),
  );
  ...
  Future<model.Result<model.NcSimpleTableList>> dbTableList({
    ...
    method: HttpMethod.get,
    pathSegments: ['/api/v1/db/meta/projects', projectId, 'tables'],
  ...
  Future<model.Result<model.NcTable>> dbTableRead({
    ...
    method: HttpMethod.get,
    pathSegments: ['/api/v1/db/meta/tables', tableId],
  ...
  Future<model.Result<model.ViewList>> dbViewList({
    ...
    method: HttpMethod.get,
    pathSegments: ['/api/v1/db/meta/tables', tableId, 'views'],
  ...
  Future<model.Result<model.NcView>> dbViewUpdate({
    ...
    pathSegments: ['/api/v1/db/meta/views', viewId],
  ...
  Future<Result<List<model.NcViewColumn>>> dbViewColumnList({
    ...
    method: HttpMethod.get,
    pathSegments: ['/api/v1/db/meta/views', viewId, 'columns'],
    serializer: (_, data) {
  ...
  Future<Result<EmptyResult>> dbViewColumnUpdateOrder({
    ...
    required int order,
  }) async => await dbViewColumnUpdate(column: column, data: {'order': order});

  Future<Result<EmptyResult>> dbViewColumnUpdateShow({
    required model.NcViewColumn column,
    required bool show,
  }) async => await dbViewColumnUpdate(column: column, data: {'show': show});
  ...
  Future<model.Result<model.NcList<model.NcSort>>> dbTableSortList({
    ...
    method: HttpMethod.get,
    pathSegments: ['/api/v1/db/meta/views', viewId, 'sorts'],
    serializer: (res, data) =>
  ...
  Future<Result<EmptyResult>> dbTableSortDelete({
    ...
    method: HttpMethod.delete,
    pathSegments: ['/api/v1/db/meta/sorts', sortId],
    serializer: (res, data) => emptyResult,
  );
  ...
  Future<Result<EmptyResult>> dbTableColumnCreate({
    ...
    method: HttpMethod.post,
    pathSegments: ['/api/v1/db/meta/tables', tableId, 'columns'],
    body: json.encode({
      'title': title,
      'column_name': title,
  ...
  Future<List<model.NcAttachedFile>> dbStorageUpload(List<NcFile> files) async {
